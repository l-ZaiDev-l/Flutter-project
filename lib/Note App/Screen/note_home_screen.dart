import 'package:auth_project/Login%20Signup/Screen/login.dart';
import 'package:auth_project/Login%20Signup/Widget/button.dart';
...
class _NoteHomeScreenState extends State<NotesHomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 26, 199, 139),
        title: const Text(
          "Note App",
          style: TextStyle(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: const Color.fromARGB(255, 4, 134, 91),
        child: const Icon(
          Icons.add,
          color: Colors.white,
        ),
